 ...
 * - test that the page has a title "How to cocktails"
 * - test that the page has a h1 heading "How to cocktails"
 * - test that the page has a footer with the text "All rights reserved 2022-24"
 * 
