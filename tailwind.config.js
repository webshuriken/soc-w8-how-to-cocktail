...
module.exports = {
  ...
  theme: {
    boxShadow: {
      'screaming-green': '0 0px 10px 1px rgba(87, 254, 32, 0.4), 0 0px 4px 1px rgba(87, 254, 32, 0.6)',
      'inner-screaming-green': 'inset 0 0px 10px 1px rgba(87, 254, 32, 0.4), inset 0 0px 4px 1px rgba(87, 254, 32, 0.6)',
